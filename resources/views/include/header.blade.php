...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
      <a href=#><img src="{{asset('assets/img/profile.png') }}" alt="" class="img-fluid rounded-circle"></a>
      <h1 class="text-light">
<a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
  ...
  <p>
        ...
        <a class="dropdown-item" href="{{ route('register') }}"></a>
      ...
      <nav class="nav-menu ">
        <ul>
          <li class="active"><a href="{{route('home')}}"><i class="bx bx-home"></i> <span>Accueil</span></a></li>
          <li><a href="{{route('nouveau')}}"><i class="bx bx-book-content"></i> <span>Nouveau</span></a></li>
          <li><a href="{{route('liste')}}"><i class="bx bx-file-blank"></i> <span>Liste</span></a></li>
